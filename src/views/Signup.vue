<template>
  <div class="flex flex justify-center mt-10">
    <form class="form">
      ...
      <div class="title-2"><span>SCRUM</span></div>
      <div class="input-container">
        <input v-model="guestName" class="input-mail" type="text" placeholder="Enter your name">
        <span> </span>
      </div>
      ...
      <button @click="signInAsGuest" type="button" class="submit">
